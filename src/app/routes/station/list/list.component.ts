...
export class StationListComponent implements OnInit {
    ...
    indeterminate = false;
    status = [
        { text: '未审核', value: false, type: 'default' },
        { text: '已审核', value: false, type: 'processing' },
    ...
    constructor(public msg: NzMessageService,public router:Router,public activeRoute:ActivatedRoute) {}
    ...
    add() {
        ...
        this.router.navigateByUrl('station/form')
        this.description = '';
    }
